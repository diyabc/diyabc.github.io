...
called `diyabcGUI` (<https://github.com/diyabc/diyabcGUI>) as a `shiny` web app. 
You can either install and run the standalone app, or install the `diyabcGUI` R package and run 
